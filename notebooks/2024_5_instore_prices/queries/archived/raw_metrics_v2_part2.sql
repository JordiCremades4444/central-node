...
,all_sessions as (
    ...
    where 1=1
        ...
        and ds.customer_id not in(select customer_id from do_not_consider_customer_ids)
    group by 1,2,3,4
)
...
,store_walls_sessions as (
    ...
    where 1=1
        ...
        and co.customer_id not in(select customer_id from do_not_consider_customer_ids)
