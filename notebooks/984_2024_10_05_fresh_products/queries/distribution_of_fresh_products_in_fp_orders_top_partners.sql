...
, top_partners as (
    select 
        ...
        count(distinct case when store_subvertical = 'QCPartners' and is_top_partner then concat(cast(bp.order_id as varchar), '_', cast(bp.product_external_id as varchar)) else null end) as n_pairs_orders_external_id_in_fp_orders,
        count(distinct case 
