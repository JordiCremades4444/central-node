...
select 
    ...
    ,event_name
    ,custom_attributes__product_removed_origin as product_removed_origin
...
where true
    ...
    and (event_name = 'eCommerce - RemoveFromCart')
    and custom_attributes__product_removed_origin = 'Cart Minus Button'
group by 1,2,3,4
order by 1 asc
