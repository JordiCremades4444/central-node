...
,partners_info as (
    ...
    inner join delta.mfc__groceries_content_availability_targets__odp.groceries_top_partners top_partners
        on top_partners.store_name = s.store_name
        -- we could also add the condition at a country level
...
,city_info as (
    ...
    inner join partners_info pi
        on sa.city = pi.city
        and sa.store_id = pi.store_id
    where 1=1
